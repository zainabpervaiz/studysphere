...
function AskQuestion() {
  ...
  const [highlightedId, setHighlightedId] = useState(null); // ✅ new state
  ...
  const handleSubmit = (e) => {
    ...
    setHighlightedId(newQuestion.id); // ✅ highlight this new question
    ...
    <div style={{ display: "flex", gap: "20px", padding: "20px", background: "#f9fafb" }}>
      ...
      <div style={{ flex: 1 }}>
        ...
        <div style={{ marginTop: "30px" }}>
          ...
          {filteredQuestions.length === 0 && <p>Define biology?<br></br></p>}
          {filteredQuestions.map(q => (
            <div key={q.id} style={{
              background: highlightedId === q.id ? "#fff9c4" : "#fff", // ✅ highlight color
